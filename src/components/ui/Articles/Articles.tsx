              ...
              ? articlesList.map((item, index) => (
                <div key={index} className="w-full border border-zinc-800 rounded-xl p-5">
                  ...
                  <div className="w-full flex items-center justify-between mt-6">
                    <Link href={'/articles/category/' + item.attributes?.category?.data.id} className="text-zinc-500 font-medium text-sm hover:text-white transition-colors ease-linear">
